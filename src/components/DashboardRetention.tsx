  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-card border text-[13px] border-border p-3 rounded-lg shadow-lg">
        <p className="font-semibold text-foreground mb-1">{label.includes('min') ? label : `Dia ${label}`}</p>
    ...
    <div className="flex flex-col gap-[20px] max-w-[1024px] mx-auto w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <Card className="lg:col-span-1 border-border bg-card flex flex-col p-[20px]">
          ...
          <div className="text-[48px] font-bold text-foreground mb-1 leading-none tracking-tight">15,8%</div>
          ...
          <div className="mt-auto pt-4 border-t border-border flex justify-between text-[13px]">
            <div>
              ...
              <div className="font-semibold text-foreground">16.642 sessões</div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="h-[220px] w-full flex-1">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={channelData} layout="vertical" margin={{ top: 0, right: 40, left: 10, bottom: 0 }}>
                  ...
                  <Bar dataKey="rate" name="Retenção" radius={[0, 4, 4, 0]} barSize={12} background={{ fill: '#f1f5f9', radius: [0,4,4,0] }}>
        ...
        >
          <div className="flex-1 flex flex-col justify-center min-h-[220px]">
            <div className="h-[220px] w-full flex-1">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={timeData} margin={{ top: 20, right: 10, left: -20, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#e2e8f0" />
                  ...
                  <Tooltip cursor={{ fill: 'rgba(0,0,0,0.05)' }} contentStyle={{ backgroundColor: '#ffffff', borderColor: '#e2e8f0', borderRadius: '8px' }} />
                  <Bar dataKey="percentage" name="Concentração" radius={[4, 4, 0, 0]} barSize={24}>
