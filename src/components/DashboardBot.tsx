        ...
        <Card className="lg:col-span-1 border-border bg-card flex flex-col p-[20px]">
          ...
          <div className="mt-auto pt-4 border-t border-border flex justify-between text-[13px]">
            <div>
              ...
              <div className="font-semibold text-foreground">30.403 sessões</div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="flex-1 flex flex-col justify-center min-h-[220px]">
            <div className="h-[220px] w-full flex-1">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={fluxosData} layout="vertical" margin={{ top: 0, right: 40, left: 10, bottom: 0 }}>
                  ...
                  <Bar dataKey="rate" name="Resolução" radius={[0, 4, 4, 0]} barSize={12} background={{ fill: '#f1f5f9', radius: [0,4,4,0] }}>
        ...
        >
          <div className="flex-1 flex flex-col justify-center min-h-[220px]">
            <div className="h-[220px] w-full flex-1">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={motivosTransferenciaData} layout="vertical" margin={{ top: 0, right: 40, left: 10, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" horizontal={true} vertical={false} stroke="#e2e8f0" />
                  <XAxis type="number" domain={[0, 100]} hide />
                  <YAxis type="category" dataKey="reason" axisLine={false} tickLine={false} tick={{ fill: '#64748b', fontSize: 11 }} width={120} />
                  <Tooltip cursor={{ fill: 'rgba(0,0,0,0.05)' }} contentStyle={{ backgroundColor: '#ffffff', borderColor: '#e2e8f0', borderRadius: '8px' }} />
                  <Bar dataKey="percentage" name="Ocorrência" radius={[0, 4, 4, 0]} barSize={12} background={{ fill: '#f1f5f9', radius: [0,4,4,0] }}>
